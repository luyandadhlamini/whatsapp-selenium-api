...
version = '0.0.1'
setup(
  name = 'whatsapp-selenium-api',         
  packages = ['whatsapp-selenium-api'],   
  version = version,      
  license='MIT',        
  description = """A pythonic implementation of common Whatsapp Web functionality using Selenium Webdriver.""",   
  author = 'Luyanda Dhlamini',                   
  author_email = 'luyanda.dhlamini@gmail.com',  
  url = 'https://github.com/luyandadhlamini',   
  download_url = 'https://github.com/luyandadhlamini/whatsapp_selenium_api/archive/refs/tags/v{}.tar.gz'.format(version), 
  keywords = ['Python', 'Whatsapp', 'Selenium', 'Logging', 'Wrapper' ],   
  install_requires=[            
          'selenium',
          'sqlalchemy',
          'pandas'
